// SwayTests.cs — §6 sway physics conformance.
...
public class SwayTests
{
    ...
    public void PureSwayMatchesSpecFormula()
    {
        ...
        double expected = Math.Sin(1.2 + t * Constants.BaseSwaySpeed)
                          * Constants.BaseAmplitude * 0.8;
    ...
    public void GustDecaysExponentially()
    {
        ...
        double expectedGust = 10.0 * Math.Exp(-Constants.DecayRate * dt);
    ...
    public void LeanBoundedUnderNominalConditions()
    {
        ...
        Assert.InRange(maxAbs, Constants.BaseAmplitude * 0.999, Constants.BaseAmplitude + 1e-9);
    }
    ...
    public void StiffnessScalesAmplitude()
    {
        ...
        Assert.Equal(Constants.BaseAmplitude, stiff.EffectiveLean, 9);
        Assert.Equal(Constants.BaseAmplitude * 0.6, floppy.EffectiveLean, 9);
    }
