...
> retained as a source-available, build/unit-covered reference without an
> ongoing feature-parity or platform-hardening commitment. See the root
> [`README`](../../README.md) for current policy.
